...
// const fourthPath = `M.227 71v-6.136l23.046-25.228c2.704-2.954 4.931-5.522 6.681-7.704 1.75-2.205 3.046-4.273 3.887-6.205.864-1.954 1.295-4 1.295-6.136 0-2.455-.59-4.58-1.772-6.375-1.16-1.795-2.75-3.182-4.773-4.16-2.023-.976-4.296-1.465-6.818-1.465-2.682 0-5.023.557-7.023 1.67a11.5 11.5 0 00-4.602 4.603c-1.068 1.977-1.603 4.295-1.603 6.954H.5c0-4.09.943-7.682 2.83-10.773 1.886-3.09 4.454-5.5 7.704-7.227 3.273-1.727 6.943-2.59 11.011-2.59 4.091 0 7.716.863 10.875 2.59 3.16 1.727 5.637 4.057 7.432 6.989 1.796 2.932 2.694 6.193 2.694 9.784 0 2.568-.466 5.08-1.398 7.534-.91 2.432-2.5 5.148-4.773 8.148-2.25 2.977-5.375 6.613-9.375 10.909L11.818 62.955v.545h32.455V71H.227z`;
const parseOne = parse(onePath);
const parseTwo = parse(twoPath);
const parseThree = parse(threePath);
// const parseFourth = parse(fourthPath);

const WalkthroughAnimation = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: "#1F456E" }}>
      <View style={{ flex: 4, justifyContent: "center", alignItems: "center" }}>
        ...
        <Animated.FlatList
          ...
          renderItem={({ item, index }) => {
            return (
              ...
              >
                <View style={styles.roadContainerStyle}>
                  <View style={styles.blackStripeStyle} />
                  <View style={styles.blackStripeStyle} />
                  <View style={styles.blackStripeStyle} />
                  <View style={styles.blackStripeStyle} />
                </View>
        ...
        >
          <Lottie
            source={require("./assets/animation files/1446-bikingiscool.json")}
            autoPlay
            loop
          />
        </View>
...
export default WalkthroughAnimation;
